...
import { getShowStaticMenuList, getAllBreadcrumbList } from '@/utils/index.js';
...
const authStore = defineStore('auth', {
  ...
  actions: {
    ...
    async listRouters() {
      ...
      this.menuList = staticRouter;
      // 持久化递归菜单数据，左侧菜单栏渲染，这里的菜单将后端数据进行递归，需要将动态路由 isHide == 0 的剔除，将静态路由 isHide == 0 的剔除
      this.recursiveMenuList = getShowStaticMenuList(staticRouter);
    },
